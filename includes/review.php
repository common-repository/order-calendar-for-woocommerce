...
v1.0.0
*/
if(!class_exists('pisol_ocfw_order_calendar_review')){
class pisol_ocfw_order_calendar_review{
...
new pisol_ocfw_order_calendar_review('Order calendar for WooCommerce', 'order-calendar-for-woocommerce');
}